                                        ...
                                        new HelpItem
                                            {
                                                ...
                                                FullText =
                                                    T(
                                                        @"To add a layer, in the dashboard, click Widgets. On the Widgets screen, click Add a new layer. The Add Layer screen is displayed.<br/><br/>
                                                            To define the new layer, enter the name of the layer, a description, and the rule that defines the layer. When you're finished, click Save.<br/><br/>
                                        ...
                                        new HelpItem
                                            {
                                                ...
                                                FullText = T("True if the user is logged in."),
                                            },
                                    }
                            }
                    };
